...
app = MCPProxy(
    ...
    version='v1',
    servers=[{'url': 'https://chromeuxreport.googleapis.com/'}],
)
...
@app.post(
    ...
    tags=['chromeuxreport_queries'],
)
def chromeuxreport_records_query_history_record(
...
def chromeuxreport_records_query_record(
    field__xgafv: Optional[FieldXgafv] = Query(None, alias='$.xgafv'),
    access_token: Optional[str] = None,
    alt: Optional[Alt] = None,
    callback: Optional[str] = None,
